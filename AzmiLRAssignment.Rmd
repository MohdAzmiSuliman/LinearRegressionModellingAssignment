...
When innfluece samples were removed, there were 481 samples.  
...
Qualitatively, diagnostic plot for Final Model without Influence look *leaner*, but otherwise does not seem different much.
...
Multiple Linear Regression Analysis show that length, gender and parity had singificant linear relationship to head circumference. The model explains 39.9% of variation of head circumference in the study sample.  

The relationship can be explained as below

- those with 1 cm length increment have increment of 0.31cm head circumference when adjusted to gender and parity
- When comparing female against male, female baby will have 0.53cm lower head circumference, when adjusted to length and parity
- when comparing one sibling to singleton baby, one sibling will have 0.28cm higher head circumference, when adjusted to length and gender
- when comparing two sibling to singleton baby, two sibling will have 0.38cm higher head circumference, when adjusted to length and gender
- when comparing 3 or more sibling to singleton baby, 3 or more sibling will have 0.17cm higher head circumference, when adjusted to length and gender
